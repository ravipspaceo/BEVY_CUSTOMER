...
//  therichest
//
//  Created by CompanyName on 2014-05-05.
...
- (void)badgeInit
{
    ...
    self.badgeFont      = [GlobalManager fontMuseoSans300:9];
    self.badgePadding   = 2;
    self.badgeMinSize   = 8;
    self.badgeOriginX   = (self.frame.size.width - self.frame.size.width/2) + 2;
    self.badgeOriginY   = 17;//-4;
