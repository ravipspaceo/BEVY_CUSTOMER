...
//
//  Created by CompanyName 4/23/13.
...
{
    if (URL == nil || [URL.absoluteString isEqualToString:@""] || !([URL.absoluteString rangeOfString:@"noimage.gif"].location == NSNotFound) || ![[UIApplication sharedApplication] canOpenURL:URL])
    {
