...
@property IBOutlet PKTextField *cardADDRESSZip;
@property IBOutlet UIImageView *placeholderView;

@property(nonatomic,retain) UILabel *lblCardNo;
@property(nonatomic,retain) UILabel *lblMMYY;

@property(nonatomic,retain) UILabel *lblCVC;

@property(nonatomic,retain) UILabel *lblPostelCode;
