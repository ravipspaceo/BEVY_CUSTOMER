...
@synthesize reference,placeid, sensor, key, language, resultBlock;
...
- (NSString *)googleURLString {
    NSMutableString *url = [NSMutableString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/details/json?placeid=%@&sensor=%@&key=%@",placeid, SPBooleanStringForBool(sensor), key];
