...
//  SMPageControl
//
//  Created by CompanyName on 10/13/12.
...
#define DEFAULT_INDICATOR_MARGIN_LARGE 0.0f
...
//				image = _currentPageIndicatorImage;
                 image= [UIImage imageNamed:@"slider_icon_act.png"];
			}
		} else {
...
//				image = _pageIndicatorImage;
                 ...
                 image = [UIImage imageNamed:@"slider_icon"];
                if (self.tag == 100)
